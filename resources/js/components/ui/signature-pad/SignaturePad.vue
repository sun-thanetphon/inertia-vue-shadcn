...
<template>
  <div class="flex flex-col gap-2.5 w-full select-none">
    ...
    <div
      ref="containerRef"
      class="relative w-full rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 overflow-hidden shadow-xs transition-colors focus-within:border-primary/80"
      :class="[heightClass, { 'opacity-60 pointer-events-none': disabled }]"
    >
      <canvas
        ref="canvasRef"
